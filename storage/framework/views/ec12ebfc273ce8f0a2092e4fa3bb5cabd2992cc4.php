                            ...
                            <nav class="cust-nav navbar header-top navbar-expand-lg navbar-dark container">
                                ...
                                <div class="collapse navbar-collapse" id="navbarText">
                                    ...
                                    <ul class="navbar-nav">
                                        ...
                                        <?php else: ?>
                                            <li class="nav-item">
                                                    <a class="nav-link <?php echo e(request()->is('sell*') ? 'active' : ''); ?>"
                                                       href="<?php echo e(Auth::guest() ? route('register') : route('add_book')); ?>"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="manues">
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo e(url('register')); ?>">Sell</a></li>
                            </ul>
...
<?php /**PATH C:\xampp\htdocs\schoolshark_l\resources\views/layouts/app.blade.php ENDPATH**/ ?>