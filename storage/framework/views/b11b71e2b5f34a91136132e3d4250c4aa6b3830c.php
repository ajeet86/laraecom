...
<div id="content" class="bg-container">
            ...
            <div class="card">
                ...
                <div class="card-block m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="<?php echo e(url('admin/testimonial')); ?>" id="editable_table_new" class=" btn btn-default">
                                Add Testimonial  <i class="fa fa-plus"></i>
                            </a>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            table.DataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": base_url + 'admin/fetchtestimonials',
                "columnDefs": [
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/testimonials_list.blade.php ENDPATH**/ ?>