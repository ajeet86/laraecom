                    ...
                    <div class="contact-info"> 
                        <div class="cont-info">
                            <div class="row">
                                ...
                                <div class="col-md-6"> <div class="login-p"> Already have an account? <a href="<?php echo e(url('/login')); ?>"> Log in </a> </div> </div>
                                <form class="form-horizontal mobile-email-wrap" method="POST" id="shipping-form">
                                ...
                                <div class="col-md-4">
                                    <div class="pin-code">
                                        <input type="text" placeholder="PIN code"
                                               class="shipping_pinCode" name="pincode"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\schoolshark\resources\views/shipping.blade.php ENDPATH**/ ?>