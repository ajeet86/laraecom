            ...
            <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="gallery-sec">
                    ...
                    <div class="main-lest-items">
                        ...
                        <?php if(Auth::guest() || ($book->user_id != Auth::user()->id)): ?>
                        <div class="numbers-text">
                            <?php if($related_author_book->org_price > $related_author_book->listing_price): ?>
                            <p class="test">$<?php echo e($related_author_book->org_price); ?></p>
                            <?php endif; ?>
                            <p><?php echo e($related_author_book->listing_price); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\schoolshark\resources\views/book_details.blade.php ENDPATH**/ ?>