<!--wrapper-->
                ...
                <div class="tab-pane" id="favourites">
                    <div id="requests" class="mx-3">
                        ...
                        <div class="data m-t-10">
                            <div class="row">
                                <div class="col-2">
                                    <img src="<?php echo e(asset('public/admn/img/images1.jpg')); ?>" class="message-img avatar rounded-circle" alt="avatar1"></div>
                        ...
                        <div class="data">
                            <div class="row">
                                <div class="col-2">
                                    <img src="<?php echo e(asset('public/admn/img/mailbox_imgs/8.jpg')); ?>" class="message-img avatar rounded-circle" alt="avatar1">
                                </div>
                        ...
                        <div class="data">
                            <div class="row">
                                <div class="col-2">
                                    <img src="<?php echo e(asset('public/admn/img/mailbox_imgs/3.jpg')); ?>" class="message-img avatar rounded-circle" alt="avatar1">
                                </div>
                                <div class="col-8 message-data">
                        ...
                        <div class="data m-t-10">
                            <div class="row">
                                <div class="col-2">
                                    <img src="<?php echo e(asset('public/admn/img/mailbox_imgs/7.jpg')); ?>" class="message-img avatar rounded-circle" alt="avatar1">
                                </div>
                                <div class="col-8 message-data">
                        ...
                        <div class="data">
                            <div class="row">
                                <div class="col-2">
                                    <img src="<?php echo e(asset('public/admn/img/mailbox_imgs/6.jpg')); ?>" class="message-img avatar rounded-circle" alt="avatar1">
                                </div>
                                <div class="col-8 message-data">
                        ...
                        <div class="data">
                            <div class="row">
                                <div class="col-2">
                                    <img src="<?php echo e(asset('public/admn/img/mailbox_imgs/4.jpg')); ?>" class="message-img avatar rounded-circle"
                                         alt="avatar1"></div>
                                <div class="col-8 message-data">
            ...
            <div class="well-small dark m-t-15">
                <div class="row m-0">
                    <div class="col-lg-12 p-d-0">
                        <div class="skinmulti_btn" onclick="javascript:loadjscssfile('<?php echo e(asset("public/admn/css/blue_black_skin.css")); ?>','css')">
                            <div class="skin_blue skin_size b_t_r"></div>
                            <div class="skin_blue_border skin_shaddow skin_size b_b_r"></div>
                        </div>
                        <div class="skinmulti_btn" onclick="javascript:loadjscssfile('<?php echo e(asset("green_black_skin.css")); ?>','css')">
    ...
    </div><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/layout/right_sidebar.blade.php ENDPATH**/ ?>