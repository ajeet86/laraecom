        ...
        <div class="checkout-info">
            <div class="row">	
                <div class="col-md-12 col-sm-12">
                    <div class="shipping">
                        <h6>Checkout</h6>
                        <img src="<?php echo e(url('public/sites/images/single-img.png')); ?>">
                    </div>
                </div>
            </div>
            <div class="row">	
                                ...
                                <div class="total-code">
                                    <ul>
                                        ...
                                        <li> <label class="Sub-total">Shipping</label>
                                            <span class="total fedx-option-list">$<?php echo e(session('shipping_amount') . " " .session('shipping_currency')); ?></span>
                                        </li>
                                        <li> <label class="Sub-total-total">Total </label>  <span class="total-all"> $<span id="total"><?php echo e(number_format($total+session('shipping_amount'), 2)); ?> USD</span> </span>  </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/user/checkout.blade.php ENDPATH**/ ?>