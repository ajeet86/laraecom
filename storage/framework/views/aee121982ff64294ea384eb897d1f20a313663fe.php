    ...
    <div class="outer">
        <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-2">
                                <button id="refund_order" 
                                        ...
                                        data-ordid="<?php echo e($order_id); ?>"
                                        data-paidamt="<?php echo e($order_details->orders[0]->paid_amount); ?>"
            ...
            <div class="box box box-success">
                ...
                <div class="box-body">
                    <div class="col-xs-12">
                        <?php $__currentLoopData = $order_details->orders[0]->shippingDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shippingDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="package-tracking-detls">
                            <p>Package Tracking Number: <?php echo e($shippingDetail->pkg_tracking_no); ?></p>
                            <button class="cancel_order"
                                        ord_id="<?php echo e($order_id); ?>"
                                        ptrckid="<?php echo e($shippingDetail->pkg_tracking_no); ?>"
                                        seller_id="<?php echo e($shippingDetail->seller_id); ?>"
                                        type="button"
            ...
            <table id="cart" class="table table-hover table-condensed table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-th="Subtotal" class="text-center">$<?php echo e(number_format($order_detail->amount * $order_detail->quantity,2)); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
            <div class="order-detail-sec">
                <table class="table table-striped table-condensed table-responsive" id="order-detail-shipping-wrap">
                    ...
                    <tbody>
                        <tr>
                            <td><?php echo e($order_details->first_name); ?> <?php echo e($order_details->last_name); ?></td>
                            <td>
                                ...
                                <?php echo e($order_details->country.','); ?> <?php echo e($order_details->pin_code); ?> </td>
                            <td>Paypal</td>
                            <td class="text-right">Item(s) Subtotal:</td>
                            <td class="text-right"> $<?php echo e(number_format($order_details->orders[0]->amount,2)); ?></td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/order_details.blade.php ENDPATH**/ ?>