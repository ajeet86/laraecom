...
<?php $__env->startSection('title', 'FAQ/HOW TO SHIP | abc'); ?>
<?php $__env->startSection('description', 'FREQUENTLY ASKED QUESTIONS WHAT IS YOUR 100% BUYER GUARANTEE?  Here at abc, the biggest thing we strive for from our customers is TRUST. Because of this, we created the 100% buyer guarantee. What this means is that if you purchase a book, we guarantee you get your book or your money back! HOW DO I LIST A BOOK?'); ?>
...
<!--<div>
  <div>
    <div>
      ...
      <div>
        <div></div>
        <div><strong><img src="https://cdn.shopify.com/s/files/1/0014/3782/7117/files/isolated_logo_medium.png?v=1553782669" alt="do"></strong></div>
        <div></div>
        <div></div>
        <div><strong>FREQUENTLY ASKED QUESTIONS</strong></div>
        <div><strong>WHAT IS YOUR 100% BUYER GUARANTEE?&nbsp;</strong></div>
        <div>Here at abc, the biggest thing   we strive for from our customers is TRUST. Because of this, we created   the 100% buyer guarantee. What this means is that if you purchase a   book, we guarantee you get your book or your money back!</div>
        <div></div>
        <div><strong>HOW DO I LIST A BOOK?</strong></div>
        <div></div>
        <div>Simple! Click on our menu in the top right corner on mobile, or click sell on desktop. Then follow the instructions!</div>
        <div></div>
        <p>&nbsp;</p>
        ...
        <p>If there is an issue with the delivery of your book or it's condition, please email schoolsharkllc@gmail.com&nbsp;</p>
        <p><strong>&#65279;ANY ADDITIONAL QUESTIONS? EMAIL US AT schoolsharkllc@gmail.com</strong></p>
        <p>&nbsp;</p>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/faq.blade.php ENDPATH**/ ?>