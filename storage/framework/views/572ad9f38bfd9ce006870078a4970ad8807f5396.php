...
<div id="content" class="bg-container">
                            ...
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Email</th>
                                        <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Phone</th>
                                        <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Body Message</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            table.DataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": base_url + 'admin/fetchContact',
                "columnDefs": [
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/contact_us_list.blade.php ENDPATH**/ ?>