...
<?php $__env->startSection('title','Book Listing'); ?>
...
<div id="content" class="bg-container">
            ...
            <div class="card">
                ...
                <div class="card-block m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="<?php echo e(url('admin/book')); ?>" id="editable_table_new" class=" btn btn-default">
                            ...
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Seller</th>
                                        <th class="sorting wid-15" tabindex="0" rowspan="1" colspan="1">Created At</th>
										<th class="sorting wid-15" tabindex="0" rowspan="1" colspan="1">Top Picks</th>
    ...
    <script>
		...
		function top_picks(book_id){
            if(book_id>0){
                location.href = base_url + 'admin/top_picks/' + book_id;
            }
        }
	</script>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/book_list.blade.php ENDPATH**/ ?>