                            ...
                            <div class="btn-group">
                                <div class="user-settings no-bg">
                                    <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                                        <img src="<?php echo e(isset(Auth::user()->avatar)
                    ...
                    <div class="menu_scroll">
                                ...
                                <div class="user-wrapper">
                                    <a class="user-link" href="#">  
                                        <img class="media-object img-thumbnail user-img rounded-circle admin_img3" alt="User Picture"
                                            src="<?php echo e(isset(Auth::user()->avatar)
                                                ? url('public/images/users/' . Auth::user()->avatar)
                                                : url('public/images/users/default.png')); ?>">
                        ...
                        <ul id="menu">
                            ...
                            <li class="dropdown_menu">
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo e(url('admin/order_list')); ?>">
                                            <i class="fa fa-gift"></i>
                                            &nbsp; Order List
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('admin/order/cancel_request_list')); ?>">
                                            <i class="fa fa-gift"></i>
                                            &nbsp; Order Cancellation Request
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('admin/order/refund_list')); ?>">
                                            <i class="fa fa-gift"></i>
                                            &nbsp; Refund History
                                        </a>
                                    </li>
                            ...
                            <li class="dropdown_menu">
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo e(url('admin/cms_list')); ?>">
                                            <i class="fa fa-angle-right"></i>
                                            &nbsp; CMS List
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('admin/cms')); ?>">
                                            <i class="fa fa-angle-right"></i>
                                            &nbsp; Add CMS
                                        </a>
                                    </li>
									<li>
                                        <a href="<?php echo e(url('admin/homecms')); ?>">
                                            <i class="fa fa-angle-right"></i>
                                            &nbsp; Homepage Cms
                                        </a>
                                    </li>
                            ...
                            <li class="dropdown_menu">
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo e(url('admin/tag_list')); ?>">
                                            <i class="fa fa-angle-right"></i>
                                            &nbsp; Tag List
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('admin/tag')); ?>">
                                            <i class="fa fa-angle-right"></i>
                                            &nbsp; Add Tag
                                        </a>
                                    </li>
                            ...
                            <li class="dropdown_menu">
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo e(url('admin/blog_list')); ?>">
                                            <i class="fa fa-angle-right"></i>
                                            &nbsp; Blog List
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="<?php echo e(url('admin/blog_approval')); ?>">
                                            <i class="fa fa-angle-right"></i>
                                            &nbsp; Blog Comment Approval
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('admin/gallary')); ?>">
                                            <i class="fa fa-angle-right"></i>
                                            &nbsp; Add To Gallery
                                        </a>
                                    </li>
                            ...
                            <li class="dropdown_menu">
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo e(url('admin/pod_list')); ?>">
                                            <i class="fa fa-angle-right"></i>
                                            &nbsp; Pod List
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('admin/podcast')); ?>">
                                            <i class="fa fa-angle-right"></i>
                                            &nbsp; Add Pod
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('admin/pod_approval')); ?>">
                                            <i class="fa fa-angle-right"></i>
							...
							<li>
                                <a href="<?php echo e(url('admin/seller_rating')); ?>">
                                    <i class="fa fa-star"></i>
                                    <span class="link-title menu_hide">&nbsp;Seller Rating</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('admin/contact_us_list')); ?>">
...
</html><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/layout/app.blade.php ENDPATH**/ ?>