...
<div id="content" class="bg-container">
            ...
            <div class="card">
                ...
                <div class="card-block m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="<?php echo e(url('admin/category')); ?>" id="editable_table_new" class=" btn btn-default">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolshark1/resources/views/admin/category_list.blade.php ENDPATH**/ ?>