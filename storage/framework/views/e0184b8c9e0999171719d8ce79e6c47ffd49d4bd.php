                    ...
                    <div class="">
                        <div class="fix-sc" data-toggle="sticky-onscroll">
                            <nav class="cust-nav navbar header-top navbar-expand-lg navbar-dark">
                                <a href="<?php echo e(url('/')); ?>" class="logo-dash"> <img src="<?php echo e(asset('public/sites/images/logo.png')); ?>">  </a>
                        ...
                        <ul>
                            ...
                            <li> 
                                <a href="<?php echo e(route('my_book_list')); ?>">
                                    <i class="fa fa-gift" aria-hidden="true"></i> My Books 
                                </a> 
                            </li>    
                            <li> 
                                <a href="<?php echo e(route('logout')); ?>"
...
<script src="<?php echo e(URL::asset('/public/sites/js/custom.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\schoolshark\resources\views/layouts/app_user.blade.php ENDPATH**/ ?>