                ...
                <div class="col-md-6">
                    ...
                    <div class="contact-info"> 
                        <div class="shipping-add">
                            ...
                            <?php endif; ?>
                            <?php if(Session::has('fedx_err_msg')): ?>
                                <div class="alert alert-danger alert-dismissible">
                                          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                          <?php echo e(Session::get('fedx_err_msg')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/user/shipping.blade.php ENDPATH**/ ?>