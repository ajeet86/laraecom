...
<div id="content" class="bg-container">
	...
	var base_url = "<?php echo e(asset('/')); ?>"; 	
        var table = $('#editable_table');
                table.DataTable({
                        ...
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": base_url + 'admin/fetchOrders',
                        "columnDefs": [
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/order_list.blade.php ENDPATH**/ ?>