...
<div id="content" class="bg-container">
                            ...
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc" tabindex="0" rowspan="1" colspan="1">Feature Image</th>
                                        <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Blog title</th>
                                        <th class="sorting wid-15" tabindex="0" rowspan="1" colspan="1">Comment</th>
                                        <th class="sorting wid-15" tabindex="0" rowspan="1" colspan="1">Commented By</th>
    ...
    <script>
        ...
        var table = $('#editable_table');
                table.DataTable({
                        ...
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": base_url + 'admin/fetchPodUnapprovedCmt',
                        "columnDefs": [
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/pod_comment_approval_list.blade.php ENDPATH**/ ?>