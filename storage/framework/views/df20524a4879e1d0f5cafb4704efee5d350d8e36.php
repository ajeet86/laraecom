...
<div id="content" class="bg-container">
        ...
        <div class="inner bg-container">
            ...
            <div class="card">
                ...
                <div class="btn-group blog-btn">
                    <a href="<?php echo e(url('admin/blog')); ?>" id="editable_table_new" class=" btn btn-default">
    ...
    <script>
        ...
        var table = $('#editable_table');
                table.DataTable({
                        ...
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": base_url + 'admin/fetchblogs',
                        "columnDefs": [
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/blog_list.blade.php ENDPATH**/ ?>