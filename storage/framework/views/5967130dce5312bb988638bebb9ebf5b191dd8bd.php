...
<section class="blog-me" id="blog">
    <div class="container">
        ...
        <div class="row" id="tag_container">
            <?php echo $__env->make('blogs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/blog_list.blade.php ENDPATH**/ ?>