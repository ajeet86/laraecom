...
<link type="text/css" rel="stylesheet" href="<?php echo e(asset('public/admn/vendors/circliful/css/jquery.circliful.css')); ?>">
<link type="text/css" rel="stylesheet" href="<?php echo e(asset('public/admn/css/pages/index.css')); ?>">
                    ...
                    <div class="row">
                        <div class="col-12 text-center text-white">
                            <div class="lorem_background">
                                <div>
                                    <img src="<?php echo e(asset('public/admn/img/mailbox_imgs/2.jpg')); ?>" alt="lorem" class="img-fluid rounded-circle lorem_img">
                                </div>
                            ...
                            <div class="weather_img">
                                <div class="row header_align">
                                    ...
                                    <div class="icon col-5 col-sm-4">
                                        <img src="<?php echo e(asset('public/admn/img/weather1.png')); ?>" alt="weather" class="img-fluid">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                            ...
                                            <div class="row header_align">
                                                <div class="col-2 border_right days_margin_top">
                                                    <div class="day text-center">
                                                        ...
                                                        <div>
                                                            <img src="<?php echo e(asset('public/admn/img/w5.png')); ?>" alt="weather" class="img-fluid">
                                                        </div>
                                                ...
                                                <div class="col-2 border_right days_margin_top">
                                                    <div class="day text-center">
                                                        ...
                                                        <div>
                                                            <img src="<?php echo e(asset('public/admn/img/w2.png')); ?>" alt="weather" class="img-fluid">
                                                        </div>
                                                ...
                                                <div class="col-2 border_right days_margin_top">
                                                    <div class="day text-center">
                                                        ...
                                                        <div>
                                                            <img src="<?php echo e(asset('public/admn/img/w3.png')); ?>" alt="weather" class="img-fluid">
                                                        </div>
                                                ...
                                                <div class="col-2 border_right days_margin_top">
                                                    <div class="day text-center">
                                                        ...
                                                        <div>
                                                            <img src="<?php echo e(asset('public/admn/img/w4.png')); ?>" alt="weather" class="img-fluid">
                                                        </div>
...
<!--  plugin scripts -->
<script type="text/javascript" src="<?php echo e(asset('public/admn/vendors/countUp.js/js/countUp.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/admn/vendors/flip/js/jquery.flip.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/admn/js/pluginjs/jquery.sparkline.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/admn/vendors/chartist/js/chartist.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/admn/js/pluginjs/chartist-tooltip.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/admn/vendors/swiper/js/swiper.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/admn/vendors/circliful/js/jquery.circliful.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/admn/vendors/flotchart/js/jquery.flot.js')); ?>" ></script>
<script type="text/javascript" src="<?php echo e(asset('public/admn/vendors/flotchart/js/jquery.flot.resize.js')); ?>"></script>
<!--end of plugin scripts-->

<script type="text/javascript" src="<?php echo e(asset('public/admn/js/pages/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolshark1/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>