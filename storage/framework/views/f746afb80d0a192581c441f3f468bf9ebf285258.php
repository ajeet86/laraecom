                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group">
                                            <select name="user" class="form-control chzn-select" tabindex="2" required>
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group">
                                            <textarea class="editor" name="book_desc" 
                                                  cols="50" rows="6"><?php echo e(isset($book->book_desc) ? $book->book_desc : old('book_desc')); ?></textarea>                                             
                                        </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div id="coba" class="chk">
                                            ...
                                            <div id="<?php echo e($bookImages->id); ?>" class="col-md-4 col-sm-6 col-xs-6 book-image">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-9 push-lg-3">
                                        <button class="btn btn-primary" type="submit" id="button_book">
                                            ...
                                            <?php echo e(isset($book->id) ? 'Edit Book' : 'Add New'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/add_book.blade.php ENDPATH**/ ?>