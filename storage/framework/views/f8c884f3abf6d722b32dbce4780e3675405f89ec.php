            ...
            <div class="row no-gutters">
                <div class="col-6">
                    <h4 class="m-t-5">
                        ...
                        <?php echo e(isset($testimonial->id) ? 'Edit Testimonial' : 'Add Testimonial'); ?>
            ...
            <div class="card">
                ...
                <div class="card-block m-t-35">
                    ...
                    <form class="form-horizontal login_validator" id="tryitForm"
                          enctype="multipart/form-data" action="<?php echo e(isset($testimonial->id) ? url('/admin/edit_testimonial/' . $testimonial->id) : url('/admin/add_testimonial')); ?>"
                          method="post">
                        <div class="row">
                            <div class="col-12">
                                    ...
                                    <div class="col-lg-6 text-center text-lg-left">
                                        <div class="fileinput fileinput-new" 
                                            ...
                                            <div class="fileinput-new img-thumbnail text-center">
                                                ...
                                                <img src="<?php echo e(url('public/images/testimonials/original/' . $testimonial->image)); ?>"></div>
                                            <?php else: ?>
                                            <img src="" 
                                ...
                                <div class="col-xl-6 col-lg-8">
                                    <div class="input-group">
                                        <input type="text" name="name"
                                               class="form-control" value="<?php echo e(isset($testimonial->name) ? $testimonial->name : old('name')); ?>">
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-8">
                                    <div class="input-group">
                                        <textarea class="form-control" name="content"
                                                  cols="50" rows="5"><?php echo e(isset($testimonial->content) ? $testimonial->content : old('content')); ?></textarea>                                            
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/schoolsharks/resources/views/admin/add_testimonial.blade.php ENDPATH**/ ?>