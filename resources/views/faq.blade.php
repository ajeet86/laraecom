@extends('layouts.app')
@section('title', 'FAQ/HOW TO SHIP | abc')
@section('description', 'FREQUENTLY ASKED QUESTIONS WHAT IS YOUR 100% BUYER GUARANTEE?  Here at abc, the biggest thing we strive for from our customers is TRUST. Because of this, we created the 100% buyer guarantee. What this means is that if you purchase a book, we guarantee you get your book or your money back! HOW DO I LIST A BOOK?')
@section('content')
