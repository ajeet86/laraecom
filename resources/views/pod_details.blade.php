@extends('layouts.app')
@section('title', $pod->meta_title)
@section('description', $pod->meta_desc)
@section('css')
<link href="{{URL::asset('/public/sites/css/musicplayer.css')}}" rel="stylesheet">
@stop
@section('content')
        ...
        <div class="row product">
            <div class="col-lg-12 produst-right-side">
                <div class="dash-container">
                    ...
                    <span>{{ date('F d, Y', strtotime($pod->created_at)) }}</span>
                    <hr class="divider-hr">
                    <section class="" id="tag_container">
                        <div class="audio_player" >
                            <ul class="playlist" >
                                <li data-cover="{{url('public/images/pod/' . $pod->feature_image)}}" data-artist="{{ $pod->created_by }}"><a
                                        href="{{url('public/storage/upload/files/audio') . '/'. $pod->audio}}">{{ $pod->title }}</a></li>
                            </ul>
                        </div>
                        {!! $pod->content !!}
                    </section>
    ...
    <div class="container">
        <div class="com-sec">
            ...
            <div class="show_comments">
                ...
                @if($pod->comments->isNotEmpty())
                    @foreach($pod->comments as $comment)
...
<script src="{{URL::asset('/public/sites/js/musicplayer.js')}}"></script>
@stop
