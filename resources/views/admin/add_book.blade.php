                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group">
                                            <textarea class="editor" name="book_desc" 
                                                  cols="50" rows="6">{{ isset($book->book_desc) ? $book->book_desc : old('book_desc') }}</textarea>                                             
                                        </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div id="coba" class="chk">
                                            ...
                                            <div id="{{ $bookImages->id }}" class="col-md-4 col-sm-6 col-xs-6 book-image">
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group input_top_align">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   value="{{ isset($book->org_price) ? $book->org_price : old('org_price') }}" required>
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group input_top_align">
                                            ...
                                            <input type="number"
                                                   ...
                                                   id="listing_price"
                                                   class="form-control valid_float_type"
                                                   value="{{ isset($book->listing_price) ? $book->listing_price : old('listing_price') }}" required>
                                            <span class="input-group-addon">.00</span>
                                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-9 push-lg-3">
                                        <button class="btn btn-primary" type="submit" id="button_book">
                                            ...
                                            {{ isset($book->id) ? 'Edit Book' : 'Add New' }}
                                        </button>
                                        @if(!isset($book->id))
